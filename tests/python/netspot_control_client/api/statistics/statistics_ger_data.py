...
from ...models.data_message import DataMessage
...
def _get_kwargs(
    *,
    ...
    url = "{}/netspots/data".format(client.base_url)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[List["DataMessage"]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = DataMessage.from_dict(response_200_item_data)
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[List["DataMessage"]]:
    return Response(
